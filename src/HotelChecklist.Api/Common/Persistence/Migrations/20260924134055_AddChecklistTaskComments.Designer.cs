...
namespace HotelChecklist.Api.Common.Persistence.Migrations
{
    ...
    [Migration("20260924134055_AddChecklistTaskComments")]
    partial class AddChecklistTaskComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelChecklist.Domain.Entities.ChecklistTaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_checklist_task_comments");

                    b.HasIndex("AuthorUserId")
                        .HasDatabaseName("ix_checklist_task_comments_author_user_id");

                    b.HasIndex("ChecklistTaskExecutionId")
                        .HasDatabaseName("ix_checklist_task_comments_checklist_task_execution_id");

                    b.ToTable("checklist_task_comments", (string)null);
                });
            ...
            modelBuilder.Entity("HotelChecklist.Domain.Entities.ChecklistTaskComment", b =>
                {
                    b.HasOne("HotelChecklist.Domain.Entities.User", "AuthorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_checklist_task_comments_users_author_user_id");
                    ...
                    b.HasOne("HotelChecklist.Domain.Entities.ChecklistTaskExecution", "ChecklistTaskExecution")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_checklist_task_comments_checklist_task_executions_checklist");
