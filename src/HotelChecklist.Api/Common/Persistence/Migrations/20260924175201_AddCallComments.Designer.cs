...
namespace HotelChecklist.Api.Common.Persistence.Migrations
{
    ...
    [Migration("20260924175201_AddCallComments")]
    partial class AddCallComments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelChecklist.Domain.Entities.CallComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_call_comments");

                    b.HasIndex("AuthorUserId")
                        .HasDatabaseName("ix_call_comments_author_user_id");

                    b.HasIndex("CallId")
                        .HasDatabaseName("ix_call_comments_call_id");

                    b.ToTable("call_comments", (string)null);
                });
            ...
            modelBuilder.Entity("HotelChecklist.Domain.Entities.CallComment", b =>
                {
                    b.HasOne("HotelChecklist.Domain.Entities.User", "AuthorUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_call_comments_users_author_user_id");
                    ...
                    b.HasOne("HotelChecklist.Domain.Entities.Call", "Call")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_call_comments_calls_call_id");
